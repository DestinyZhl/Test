...
namespace SPP.Data.Repository
{
    public class SystemFunctionRepository : RepositoryBase<System_Function>, ISystemFunctionRepository
    {
        ...
        /// <returns></returns>
        public IEnumerable<System_Function> GetFunctionsByUserUId(int uid)
        {
            var paramUId = new SqlParameter("id", uid);

            return ((IObjectContextAdapter)this.DataContext).ObjectContext
                        .ExecuteStoreQuery<System_Function>("usp_get_functions_by_useruid @id", paramUId)
                        .AsEnumerable();
        }
    ...
    public interface ISystemFunctionRepository : IRepository<System_Function>
    {
        ...
        /// <param name="uid"></param>
        /// <returns></returns>
        IEnumerable<System_Function> GetFunctionsByUserUId(int uid);
